                ...
                <div id="post" class="tabcontent">
                    ...
                    if (isset($_POST['postedit'])) {
                        ...
                        // while ($users = mysqli_fetch_array($result)) {
                            $result = mysqli_query($conn, "SELECT p.id, p.cilent_id, p.logo_images, p.banner_images, p.project_overview, p.photos, p.technology, p.project_title, p.project_id FROM application_web p INNER JOIN project_list w ON w.id = p.cilent_id WHERE p.id = '$postid'");
                        while ($users = mysqli_fetch_array($result)) {
                    ?>
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        ...
                                        <form action='edit-add-mobile-backend.php' method='post' enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-lg-4 d-flex">
                                                        <div class="d-flex align-items-center">
                                                            <div class="py-1">
                                                                ...
                                                                <input class="form-control" type="file" name="logo_images" value="<?php echo $users['logo_images']; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-2">
                                                        <div class="py-1">
                                                            ...
                                                            <div class="row">
                                                                <?php
                                                                $banner_images = $users['banner_images']; {
                                                                    echo "<div>";
                                                    ...
                                                    <div class="col-lg-4 d-flex">
                                                        <div class="d-flex align-items-center">
                                                            <div class="py-1">
                                                                ...
                                                                <input class="form-control" type="file" name="banner_images" value="<?php echo $users['banner_images']; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="py-1">
...
<div class="col-lg-4 d-flex">
    <div class="d-flex align-items-center">
        <div class="py-1">
            ...
            <input type="hidden" id="hiddenPhotos" name="hiddenPhotos" value="<?php echo $users['photos']; ?>" />
                                                   ...
                                                   <div class="my-1">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="py-1">
                                                            ...
                                                            <input type="text" name='project_overview' value='<?php echo $users['project_overview']; ?>' class="form-control" id="imgname" placeholder="Enter the name">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="py-1">
                                                            ...
                                                            <input type="text" name='project_title' value='<?php echo $users['project_title']; ?>' class="form-control" id="imgname" placeholder="Enter the name">
                                                        </div>
                                                    </div>
                                                </div>
