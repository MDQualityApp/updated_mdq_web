...
<div class="website-background p-3" style="background-color: #F7FDFF;">
    ...
    <div class="d-flex justify-content-center align-items-center py-5">
        ...
        <div class="row py-3">
            ...
            <p class="website-para">Experience transparent and fraud-free peer-to-peer transactions through our blockchain-powered DeFi platforms and decentralized marketplaces.</p>
