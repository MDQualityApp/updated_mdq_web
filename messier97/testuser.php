                    ...
                    <table class="table table-striped table-dark css-serial text-white">
                        ...
                        <thead class="table-dark text-nowrap theader">
                            <tr>
                                ...
                                <th class='text-center px-5'>Block</th>
                ...
                <div class="text-end">
                    ...
                    <div class="text-center">
                        ...
                        if (!(isset($_POST['free_param']))) {
                            ...
                            $pr_query = "select * from users WHERE type='user' and block='false'";
