...
<div class="website-background" style="padding-top:63px">
    ...
    <div class="useclr container-fluid">
            ...
            <?php
            $id=$_GET['id'];
            $logo=mysqli_query($conn,"SELECT aw.project_title AS project_title,aw.logo_images AS logo_images,aw.banner_images AS banner_images,aw.project_overview AS project_overview,aw.photos AS photos,aw.technology AS awtechnology,aw.project_id AS project_id,tn.technology AS technology,tn.technology_images AS technology_images FROM application_web aw INNER JOIN technology_name tn ON tn.id=aw.technology Where aw.cilent_id='$id'");
