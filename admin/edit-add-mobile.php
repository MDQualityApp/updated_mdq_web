                                                    ...
                                                    <div class="col-lg-8 d-flex">
                                                        <div class="d-flex align-items-center">
                                                            <div class="py-1">
                                                                ...
                                                                <input type="file" class="form-control text-clr" id="files" multiple="multiple" name="photos[]" accept="image/*" value="<?php echo $users['photos']; ?>" />
                                                                <!-- <output id="result"></output> -->
                                                                <!-- <input class="form-control" type="file" name="photos" value="<?php echo $users['photos']; ?>"> -->
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
