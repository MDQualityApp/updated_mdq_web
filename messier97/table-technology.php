    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="row">
                    ...
                    <p class="fs-4 card-text" style="color:#1C46A8; font-weight:600"> Technology Table</p>
                        <div class="fw-bold">
                            <a href="admin-technology.php" class="nav-link align-middle px-0">
                            ...
                            <div class="wrapper">
                                <table class="table css-serial text-white" style="background-color: #111420;">
                                    ...
                                    <tbody id="post_search">
                                        ...
                                        $sql = mysqli_query($conn, "SELECT * FROM technology_name");
                                        while ($data = mysqli_fetch_array($sql)) {
                                            $technology = $data['technology'];
                                            $technology_images = $data['technology_images'];
                                        ?>
                                        <tr id="<?php echo $data['id']; ?>" class="text-nowrap text-center">
                                            <td></td>
                                            <td style="max-width: 300px; white-space:normal;"><?php echo $data['technology']; ?></td>
                                            <td><img src="../images/portfolio/<?php echo $data['technology_images']; ?>" alt="logo" width="50px" height="50px"></td>
                                            <td class='text-center'>
                                                <form action="edit-technology.php" method='POST'>
                                                    <input class='d-none' type="text" value='<?php echo $data['id']; ?>'
                                                        name='postid'>
                                                        <div>
                                                        <button style="background-color: #007BFF !important;" class='btn' type='submit' name='postedit'><i
                                                            class="bi bi-pen fs-6"></i></button>
                                                        </div>
                                                </form>
                                            </td>
                                            <td class='text-center'>
                                                <form action="delete-technology.php" method="POST">
                                                    <input class='d-none' type="text" value='<?php echo $data['id']; ?>'
                                                        name='userid'>
                                                    <button style="background-color: #007BFF !important;" class='btn posters' type='submit' name='postdelete'><i
                                ...
                                <div class="text-center" style="background-color: #2d2e37;">
                                    ...
                                    $pr_query = "SELECT * FROM technology_name";
