                            ...
                            <div class="wrapper">
                                <table class="table css-serial text-white" style="background-color: #111420;">
                                    ...
                                    <tbody id="post_search">
                                       ...
                                       $sqlTable1 = mysqli_query($conn, "SELECT id FROM web_details");
                                        $resultTable1 = mysqli_fetch_array($sqlTable1);

                                        while ($rowTable1 = mysqli_fetch_array($sqlTable1)) {
                                            $table2Id = $rowTable1['id'];

                                        $sql = mysqli_query($conn, "SELECT a.id, a.cilent_id, a.weblogo_images, a.webbanner_images, a.webproject_overview, a.webphotos, a.technology, a.webproject_title, a.project_id, p.projectname FROM web_details a INNER JOIN project_list p ON p.id = a.cilent_id WHERE a.id = '$table2Id'");
                                        while ($data = mysqli_fetch_array($sql)) {
                                            $client_id = $data['cilent_id'];
                                            $logo_images = $data['weblogo_images'];
                                            $banner_images = $data['webbanner_images'];
                                            $project_overview = $data['webproject_overview'];
                                            $photos = $data['webphotos'];
                                            $technology = $data['technology'];
                                            $project_title = $data['webproject_title'];
                                        ...
                                        <tr id="<?php echo $data['id']; ?>" class="text-nowrap text-center">
                                            ...
                                            <td><img src="../images/portfolio/<?php echo $data['weblogo_images']; ?>" alt="logo" width="100px" height="100px"></td>
                                            <td><img src="../images/portfolio/<?php echo $data['webbanner_images']; ?>" alt="logo" width="100px" height="100px"></td>
                                            <td style="max-width: 200px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo $data['webproject_overview']; ?></td>
                                            <!-- <td><img src="../images/portfolio/<?php echo $data['webphotos']; ?>" alt="logo" width="100px" height="100px"></td> -->
<td> <?php
                                                                $photoString = $data['webphotos'];
                                            ...
                                            <td style="max-width: 200px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo $data['webproject_title']; ?></td>
                                            <td class='text-center'>
                                                <form action="edit-add-web.php" method='POST'>
                                            ...
                                            <td class='text-center'>
                                                <form action="delete-add-web.php" method="POST">
                                                    <input class='d-none' type="text" value='<?php echo $data['id']; ?>'
                                                        name='userid'>
