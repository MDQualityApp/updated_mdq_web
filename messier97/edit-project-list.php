                                                ...
                                                <div class="row gy-3">
                                                    ...
                                                    <div class="col-lg-4 d-flex">
                                                        <div class="d-flex align-items-center">
                                                            <div class="py-1">
                                                                ...
                                                                <!-- Display current image value -->
                                                                <input class="form-control" type="text" value="<?php echo $users['image']; ?>" readonly>
                                                    ...
                                                    <div class="col-lg-4 d-flex">
                                                        <div class="d-flex align-items-center">
                                                            <div class="py-1">
                                                                <label for="image" class="form-label">Update Image</label>
                                                                <input class="form-control" type="text" value="<?php echo $users['sec_image']; ?>" readonly>
                                                                <input class="form-control" type="file" name="sec_image" id="secImageInput">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
